...
const POPULAR_SERVICES: PopularService[] = [
  ...
  { name: 'iCloud', defaultCategory: 'storage' },
  { name: 'Google One', defaultCategory: 'storage' },
  ...
  { name: 'Dropbox', defaultCategory: 'storage' },
  { name: 'Microsoft 365', defaultCategory: 'productivity' },
  { name: 'LinkedIn Premium', defaultCategory: 'productivity' },
  { name: 'Headspace', defaultCategory: 'health' },
  { name: 'Calm', defaultCategory: 'health' },
  { name: 'Strava', defaultCategory: 'health' },
